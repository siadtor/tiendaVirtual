			...
			<div class="row">
              ...
              <div class="col-sm-7">
                <div class="product-information"><!--/product-information-->
                  ...
                  <h2><?php echo $filas['Nombre'] ?></h2>
                  <p>Web ID: <?php echo $filas['SKU'] ?></p>
                  <!--<img src="images/product-details/rating.png" alt="" />-->
                  <form action="" method="post">
                    <span>
                      <span>L<?php echo $filas['Precio'] ?></span>
                      <label for="cantidadproducto">CANTIDAD:</label>
                      <input id="cantidadproducto" name="cantidadproducto" type="number" value="1" onchange="cargarcantidad()" >
                    </span>
                    <br/>
                    <p><b>Disponibilidad:</b>Disponible</p>
                    <p><b>Condicion:</b> Nueva</p>
                  ...
                  function cargarcantidad(){
                      ...
                      cadena = cadena + "?";
                      cadena = cadena + "php ";
                      cadena = cadena + "echo openssl_encrypt(";
                      cadena = cadena + document.getElementById('cantidadproducto').value;
                      cadena = cadena + ",COD,KEY);?>;";
                      //console.log(cadena);
                      document.getElementById('cantidad').value= cadena;
                      //console.log(document.getElementById('cantidadproducto').value);
                      }
                  </script>
...
include 'template/piepagina.php'
